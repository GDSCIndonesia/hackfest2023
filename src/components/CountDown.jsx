  ...
  return (
    <section className="border-y-2 border-black">
      <div className="grid grid-cols-12">
        <div className="col-span-12 md:col-span-5 py-[60px] px-[50px] bg-gooGreen-900 border-b-2 md:border-b-0 md:border-r-2 border-black h-full">
        <img src="/public/libraries/images/svg/illustrator/countdown.svg" className="m-auto"/>
        </div>
            ...
            <div className="flex justify-center md:justify-start">
              <div className="flex bg-white">
                <div className="text-center border-2 border-black w-[90px] sm:w-[100px] lg:w-[130px] xl:w-[150px]">
                  <div className="font-gooMed text-[45px] sm:text-[50px] md:text-[60px] lg:text-[80px]">18</div>
                ...
                <div className="text-center border-2 border-l-0 border-black w-[90px] sm:w-[100px] lg:w-[130px] xl:w-[150px]">
                  <div className="font-gooMed text-[45px] sm:text-[50px] md:text-[60px] lg:text-[80px]">08</div>
                  <div className="border-t-2 border-black font-gooReg text-[14px] sm:text-[16px] md:text-[18px] py-[5px]">Hours</div>
                </div>
              </div>
              <div className="flex bg-white">
                <div className="text-center border-2 border-l-0 border-black w-[90px] sm:w-[100px] lg:w-[130px] xl:w-[150px]">
                  <div className="font-gooMed text-[45px] sm:text-[50px] md:text-[60px] lg:text-[80px]">22</div>
                  <div className="border-t-2 border-black font-gooReg text-[14px] sm:text-[16px] md:text-[18px] py-[5px]">Minutes</div>
                </div>
                <div className="text-center border-2 border-l-0 border-black w-[90px] sm:w-[100px] lg:w-[130px] xl:w-[150px]">
                  <div className="font-gooMed text-[45px] sm:text-[50px] md:text-[60px] lg:text-[80px]">40</div>
                  <div className="border-t-2 border-black font-gooReg text-[14px] sm:text-[16px] md:text-[18px] py-[5px]">Minutes</div>
                </div>
              </div>
            </div>
