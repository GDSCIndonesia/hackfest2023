export default function SessionTalkBubble({
  ...
  return (
    <div
      className={
        "flex flex-col p-8 py-12 border-2 border-black rounded-2xl " +
        (id % 2 == 0 ? "bg-gooYellow-900" : "bg-gooBlue-900 ")
      }
    >
      <div className="mb-8">
        <div className="flex justify-between relative">
          <h3 className="font-gooMed text-lg leading-none">{info}</h3>
        </div>
        <p className="font-gooBold text-2xl leading-relaxed">{title}</p>
      </div>
