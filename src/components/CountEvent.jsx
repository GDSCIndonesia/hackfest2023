        ...
        <div className="col-span-12 md:col-span-7 bg-gooYellow-300" id="events">
          <div className="bg-events-lines bg-cover bg-repeat-y bg-top py-[60px] lg:py-[60px] px-[30px] lg:px-[60px] w-full h-full">
            <div className="text-center md:text-left">
              <h1 className="font-gooBold text-black text-[50px] md:text-[65px] tracking-[-.10rem] md:tracking-[-.20rem]">Top 10 Solution/Apps Announcement</h1>
            ...
            <div className="my-[30px]">
              <Countdown date={new Date("2023-03-08T10:00:00")} renderer={renderer}/>
            </div>
