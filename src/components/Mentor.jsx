...
export default function Mentor() {
  ...
  return (
    <section className="border-b-2 border-black bg-gooGreen-500 py-16">
      <div className="text-center h-full">
        <h2 className="font-gooMed text-4xl mb-8">Mentors</h2>
        <p className="font-gooReg text-lg mb-8">
          Current Mentors, might change in the future.
        </p>
      </div>
