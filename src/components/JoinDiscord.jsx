        ...
        <div className="grid grid-cols-12">
            ...
            <div className="col-span-12 md:col-span-6 p-8 flex items-start md:items-center md:pr-[50px]">
                <div>
                    ...
                    <p className="text-white font-gooReg text-[13px] md:text-[12px] lg:text-[14px] mt-[10px]">Get all the information about HackFest 2023 through the official GDSC Indonesia discord channel. Don't miss it, make sure you join by pressing the button below</p>
                    <a
