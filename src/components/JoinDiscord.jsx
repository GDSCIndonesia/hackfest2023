    ...
    <section className="bg-black py-[40px] md:py-0">
        <div className="grid grid-cols-12">
            ...
            <div className="col-span-12 md:col-span-6 p-8 flex items-start md:items-center md:pr-[50px]">
                <div>
                    <h1 className="text-white font-gooBold text-[35px] sm:text-[50px] md:text-[35px] lg:text-[50px] xl:text-[60px] leading-tight">Join Our</h1>
                    <h1 className="text-white font-gooBold text-[35px] sm:text-[50px] md:text-[35px] lg:text-[50px] xl:text-[60px] leading-tight">Discord Channel</h1>
                    <p className="text-white font-gooReg text-[13px] md:text-[12px] lg:text-[14px] mt-[10px]">Get all the information about HackFest 2023 through the official Google Developers Indonesia discord channel. Don't miss it, make sure you join by pressing the button below.</p>
                    <a
